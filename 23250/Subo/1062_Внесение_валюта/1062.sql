...
null,
'13',
'СУБО.Внесение на счет клиента - валюта',
'10',
'1', 
null,
null,
...
Insert into OPERATION2EXT (OPERATION_CODE,ID_SYS_CODE,OE_EXT_ID,OE_ACC_EXPR) values ('1062','99995','_',':CBO_CODE');
Insert into OPERATION2EXT (OPERATION_CODE,ID_SYS_CODE,OE_EXT_ID,OE_ACC_EXPR) values ('1062','TRS24','cash2cardInt.Profile',null);

-- operation_to_group

Insert /*+ ignore_row_on_dupkey_index(OPERATION_TO_GROUP,PK_OPERATION_TO_GROUP) */ into OPERATION_TO_GROUP (OPERATION_GROUP_CODE,OPERATION_CODE) values (4,'1062');
Insert /*+ ignore_row_on_dupkey_index(OPERATION_TO_GROUP,PK_OPERATION_TO_GROUP) */ into OPERATION_TO_GROUP (OPERATION_GROUP_CODE,OPERATION_CODE) values (3,'1062');
Insert /*+ ignore_row_on_dupkey_index(OPERATION_TO_GROUP,PK_OPERATION_TO_GROUP) */ into OPERATION_TO_GROUP (OPERATION_GROUP_CODE,OPERATION_CODE) values (-7,'1062');
Insert /*+ ignore_row_on_dupkey_index(OPERATION_TO_GROUP,PK_OPERATION_TO_GROUP) */ into OPERATION_TO_GROUP (OPERATION_GROUP_CODE,OPERATION_CODE) values (18,'1062');
Insert /*+ ignore_row_on_dupkey_index(OPERATION_TO_GROUP,PK_OPERATION_TO_GROUP) */ into OPERATION_TO_GROUP (OPERATION_GROUP_CODE,OPERATION_CODE) values (-3,'1062');
Insert /*+ ignore_row_on_dupkey_index(OPERATION_TO_GROUP,PK_OPERATION_TO_GROUP) */ into OPERATION_TO_GROUP (OPERATION_GROUP_CODE,OPERATION_CODE) values (-23,'1062');
